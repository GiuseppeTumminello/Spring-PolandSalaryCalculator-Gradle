...
public class SalaryCalculatorControllerPostTest {
    ...
    private Map<String, BigDecimal> statisticResponseBody(
        ...
        expected.put(
                "Average",
                this.dataSalaryCalculatorRepository.findAverageByJobTitle(jobTitlesList.get(jobTitleId - 1).trim()));
        return expected;
    }
    ...
    public void getSalaryCalculation(BigDecimal grossMonthlySalary, String departmentName, int jobTitleId)
        ...
        this.mockMvc.perform(post(
                ...
                .andExpect(MockMvcResultMatchers.content()
                        .string(objectMapper.writeValueAsString(statisticResponseBody(grossMonthlySalary,
                                departmentName,
                                jobTitleId))));
    ...
    public void getSalaryCalculationIdOutOfBounds(
        ...
        Assertions.assertThrows(
                ...
                () -> this.mockMvc.perform(post(
                        ...
                        .andExpect(status().isOk())
                        .andExpect(MockMvcResultMatchers.content()
                                .string(this.objectMapper.writeValueAsString(statisticResponseBody(grossMonthlySalary,
                                        departmentName,
                                        jobTitleId)))));
    }
