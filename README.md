...
* http://localhost:8080/jobs/{departmentName}
...
* http://localhost:8080/salary-calculations/{grossSalaryMonthly}
* http://localhost:8080/salary-calculations/{grossSalaryMonthly}?departmentName={departmentName}&jobTitleId={id}
